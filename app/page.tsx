...
const copy = {
  en: {
    nav: ["Home", "About", "Reports", "Photography", "Multimedia", "Contact"],
    eyebrow: "JOURNALIST · MULTIMEDIA REPORTER",
    title: "Reporting from the field. Telling the story.",
    intro:
    ...
    footer: "Journalist & Multimedia Reporter · Dhaka, Bangladesh",
    menu: "Menu",
  },

  bn: {
    nav: ["হোম", "পরিচিতি", "রিপোর্ট", "ফটোগ্রাফি", "মাল্টিমিডিয়া", "যোগাযোগ"],
    eyebrow: "সাংবাদিক · মাল্টিমিডিয়া রিপোর্টার",
    title: "মাঠ থেকে প্রতিবেদন। গল্পের গভীরে।",
    intro:
    ...
    footer: "সাংবাদিক ও মাল্টিমিডিয়া রিপোর্টার · ঢাকা, বাংলাদেশ",
    menu: "মেনু",
  },
};
...
export default function Home() {
  ...
  return (
    <main className={lang === "bn" ? "site bn" : "site"}>
        ...
        <div className="menu-layer">
          ...
          >
            ...
            <div className="side-menu-footer">
              <span>ASADULLAH GALIB AL SADI</span>
              <small>
      ...
      >
        ...
        <div className="hero-copy">
          ...
          <div className="hero-meta">
            <span>Daily Ittefaq</span>
            <span>Digital Department</span>
      ...
      <footer className="footer">
        ...
        <div className="footer-bottom">
          ...
          <span>
            © {new Date().getFullYear()} Asadullah Galib Al Sadi
          </span>
